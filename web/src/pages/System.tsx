...
function System() {
  ...
  useEffect(() => {
    if (pageToggle) {
      document.title = `${capitalizeFirstLetter(pageToggle)} Stats - Vigision`;
    }
  }, [pageToggle]);

  // stats collection

  const { data: statsSnapshot } = useSWR<VigisionStats>("stats", {
  ...
  return (
    <div className="flex size-full flex-col p-2">
      <div className="relative flex h-11 w-full items-center justify-between">
        ...
        <div className="h-full content-center font-semibold text-xl">System Metrics</div>
      ...
      <div className="mt-2 flex items-end gap-2">
        {/* <div className="h-full content-center font-medium">Vigision System Metrics</div>
         */}
