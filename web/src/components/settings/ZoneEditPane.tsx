...
export default function ZoneEditPane({
        ...
        .then((res) => {
          if (res.status === 200) {
            toast.success(
              ...
              <p>{`Zone (${zoneName}) has been saved. Restart Vigision to apply changes.`}</p>
              <Button
                size="sm"
                onClick={() => {
  ...
  useEffect(() => {
    document.title = "Edit Zone - Vigision";
  }, []);
                ...
                <FormLabel className="flex">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="absolute w-52">
                      <div className="my-2 flex flex-col gap-2 text-sm text-primary-variant">
                        Name must be at least 2 characters and must not <br /> be the name of a camera or another zone.
                      </div>
                    </TooltipContent>
                  </Tooltip>
                </FormLabel>
