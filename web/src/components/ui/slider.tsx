...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-1 w-full grow overflow-hidden rounded-full bg-green-400/60">
      <SliderPrimitive.Range className="absolute h-full bg-green-400" />
    </SliderPrimitive.Track>
    <SliderPrimitive.Thumb className="block size-3 rounded-full bg-green-400 transition-colors cursor-col-resize disabled:pointer-events-none disabled:opacity-50" />
    <SliderPrimitive.Thumb className="block size-3 rounded-full bg-green-400 transition-colors cursor-col-resize disabled:pointer-events-none disabled:opacity-50" />
  </SliderPrimitive.Root>
));
