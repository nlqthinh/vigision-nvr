            ...
            <>
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className={`mx-auto -mt-4 bg-green-400 ${
                        dense
                          ? "w-12 md:w-20"
                          : segmentDuration < 60
                            ? "w-[80px]"
                            : "w-20"
                      } h-5 ${isDraggingExportEnd && isMobile ? "fixed left-1/2 top-[18px] z-20 mt-0 h-[30px] w-auto -translate-x-1/2 transform rounded-full bg-green-400/80 px-3" : "static rounded-tl-lg rounded-tr-lg"} flex items-center justify-center`}
                    >
                      <div
                    ...
                    <div
                      className={`absolute h-[4px] w-full bg-green-400 ${isDraggingExportEnd && isMobile ? "top-0" : "top-1/2 -translate-y-1/2 transform"}`}
                    ></div>
                  </div>
                </div>
              </div>
              <div
                ...
                className="absolute w-full bg-green-400/50"
              ></div>
              <div
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className={`absolute h-[4px] w-full bg-green-400 ${isDraggingExportStart && isMobile ? "top-[12px]" : "top-1/2 -translate-y-1/2 transform"}`}
                    ></div>
                    <div
                      className={`mx-auto mt-4 bg-green-400 ${
                        dense
                          ...
                          : segmentDuration < 60
                            ? "w-[80px]"
                            : "w-20"
                      } h-5 ${isDraggingExportStart && isMobile ? "fixed left-1/2 top-[4px] z-20 mt-0 h-[30px] w-auto -translate-x-1/2 transform rounded-full bg-green-400/80 px-3" : "static rounded-bl-lg rounded-br-lg"} flex items-center justify-center`}
                    >
                      <div
