...
export function useVigisionEvents(): { payload: VigisionEvent } {
  const {
    value: { payload },
  } = useWs("events", "");
...
export function useVigisionReviews(): { payload: VigisionReview } {
  const {
    value: { payload },
  } = useWs("reviews", "");
  return { payload: JSON.parse(payload as string) };
...
export function useVigisionStats(): { payload: VigisionStats } {
  const {
    value: { payload },
  } = useWs("stats", "");
  return { payload: JSON.parse(payload as string) };
