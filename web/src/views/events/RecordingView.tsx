      ...
      <div className="relative mb-2 flex h-11 w-full items-center justify-between px-2">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          {isDesktop ? (
            ...
            >
              <ToggleGroupItem
                className={`flex items-center gap-2.5 rounded-lg ${timelineType === "timeline" ? "" : "text-muted-foreground"}`}
                value="timeline"
                aria-label="Select timeline"
              >
                <TbTimeline className="size-5 text-secondary-foreground" />
                <div className="">Timeline</div>
              </ToggleGroupItem>
              <ToggleGroupItem
                className={`flex items-center gap-2.5 rounded-lg ${timelineType == "events" ? "" : "text-muted-foreground"}`}
                value="events"
                aria-label="Select events"
              >
                <MdEventRepeat className="size-5 text-secondary-foreground" />
