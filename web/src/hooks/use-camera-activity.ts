...
import { ATTRIBUTE_LABELS, CameraConfig } from "@/types/vigisionConfig";
...
import { useAutoVigisionStats } from "./use-stats";
...
export function useCameraActivity(
  ...
  const { payload: event } = useVigisionEvents();
  ...
  const stats = useAutoVigisionStats();
