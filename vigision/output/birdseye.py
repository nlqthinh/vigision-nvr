...
from vigision.const import BASE_DIR, BIRDSEYE_PIPE
...
class BirdsEyeFrameManager:
    def __init__(
        ...
        # initialize the frame as black and with the Vigision logo
        ...
        if birdseye_logo is None:
            logo_files = glob.glob("/opt/vigision/vigision/images/birdseye.png")
        ...
        if birdseye_logo is not None:
            ...
            logger.warning("Unable to read Vigision logo")
