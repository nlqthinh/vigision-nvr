...
from vigision.const import REGEX_HTTP_CAMERA_USER_PASS, REGEX_RTSP_CAMERA_USER_PASS
...
cameras:
  name_of_your_camera: # <------ Name the camera
    ...
    logger.info(
        "Created default config file, see the getting started docs for configuration https://docs.vigision.video/guides/getting_started"
    )
