...
from vigision.const import FREQUENCY_STATS_POINTS
from vigision.stats.util import stats_snapshot
from vigision.types import StatsTrackingTypes
...
class StatsEmitter(threading.Thread):
    def __init__(
        ...
        self.name = "vigision_stats_emitter"
        self.config = config
