...
from vigision.config import VigisionConfig, ZoomingModeEnum
from vigision.types import PTZMetricsTypes
from vigision.util.builtin import find_by_key
...
class OnvifController:
    def __init__(
        self, config: VigisionConfig, ptz_metrics: dict[str, PTZMetricsTypes]
    ) -> None:
