"""Handle communication between Vigision and other applications."""
...
from vigision.models import Previews, Recordings, ReviewSegment
from vigision.ptz.onvif import OnvifCommandEnum, OnvifController
...
class Dispatcher:
    """Handle communication between Vigision and communicators."""
