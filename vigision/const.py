CONFIG_DIR = "/config"
DEFAULT_DB_PATH = f"{CONFIG_DIR}/vigision.db"
MODEL_CACHE_DIR = f"{CONFIG_DIR}/model_cache"
BASE_DIR = "/media/vigision"
...
CACHE_DIR = "/tmp/cache"
YAML_EXT = (".yaml", ".yml")
VIGISION_LOCALHOST = "http://127.0.0.1:5000"
PLUS_ENV_VAR = "PLUS_API_KEY"
PLUS_API_HOST = "https://api.vigision.video"
...
JWT_SECRET_ENV_VAR = "VIGISION_JWT_SECRET"
PASSWORD_HASH_ALGORITHM = "pbkdf2_sha256"

# Notifications
APP_EMAIL_PASSWORD = "grhi bdii ijql bivu"