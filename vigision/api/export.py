...
from vigision.const import EXPORT_DIR
from vigision.models import Export, Recordings
from vigision.record.export import PlaybackFactorEnum, RecordingExporter
...
def export_recording(camera_name: str, start_time, end_time):
    if not camera_name or not current_app.vigision_config.cameras.get(camera_name):
