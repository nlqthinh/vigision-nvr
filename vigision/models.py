...
class User(Model):  # type: ignore[misc]
    ...
    email = CharField(null=True, unique=True, max_length=254)  # Add email line
    receive_alert = BooleanField(default=False)  # Add receive_alert 
    token_jti = CharField(null=True)  # This will store the current token's jti
