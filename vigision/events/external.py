...
from vigision.comms.events_updater import EventUpdatePublisher
from vigision.config import CameraConfig, VigisionConfig
from vigision.const import CLIPS_DIR
from vigision.events.types import EventStateEnum, EventTypeEnum
from vigision.util.image import draw_box_with_label
...
class ExternalEventProcessor:
    def __init__(self, config: VigisionConfig) -> None:
        self.config = config
