...
from vigision.config import CameraConfig, VigisionConfig, RetainModeEnum
from vigision.const import CACHE_DIR, CLIPS_DIR, MAX_WAL_SIZE, RECORD_DIR
from vigision.models import Event, Previews, Recordings, ReviewSegment
from vigision.record.util import remove_empty_directories, sync_recordings
from vigision.util.builtin import clear_and_unlink, get_tomorrow_at_time
...
class RecordingCleanup(threading.Thread):
    ...
    def __init__(self, config: VigisionConfig, stop_event: MpEvent) -> None:
