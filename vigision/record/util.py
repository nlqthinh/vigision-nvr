...
from vigision.const import RECORD_DIR
from vigision.models import Recordings, RecordingsToDelete
...
def sync_recordings(limited: bool) -> None:
    ...
    def delete_db_entries_without_file(check_timestamp: float) -> bool:
        """Delete db entries where file was deleted outside of vigision."""
    ...
    def delete_files_without_db_entry(files_on_disk: list[str]):
        """Delete files where file is not inside vigision db."""
        files_to_delete = []
