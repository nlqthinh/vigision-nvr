...
import vigision.detectors as detectors
import vigision.object_detection
from vigision.config import DetectorConfig, ModelConfig
from vigision.detectors import DetectorTypeEnum
from vigision.detectors.detector_config import InputTensorEnum
...
class TestLocalObjectDetector(unittest.TestCase):
        ...
        for det_type in detectors.api_types:
            with self.subTest(det_type=det_type):
                with patch.dict(
                    ...
                    test_obj = vigision.object_detection.LocalObjectDetector(
    ...
    def test_detect_raw_given_tensor_input_should_return_api_detect_raw_result(self):
        ...
        test_obj_detect = vigision.object_detection.LocalObjectDetector(
    ...
    @patch("vigision.object_detection.load_labels")
